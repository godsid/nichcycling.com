<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../statics'; // absolute or relative from this script path, required.

	if(isset($_SESSION['mce_rootpath'])){
		
		$mcImageManagerConfig['filesystem.rootpath'].=$_SESSION['mce_rootpath'];
	}
	...
	$mcImageManagerConfig['filesystem.invalid_file_name_msg'] = "ชื่อไฟล์สามารถตั้งได้แค่อักษร a-z, 0-9,_,- เท่านั้น ";
