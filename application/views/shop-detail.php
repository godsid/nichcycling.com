  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row cb-af main-detail">
      	<div class="_sf-col-xs-12-sm-8"><img src="img/thumb/thumb_440x340-03.jpg" alt="Shop nich"></div>
        <div class="_sf-col-xs-12-sm-4 txt-r social">
        	<h1>NICH<br>Carbon Cage</h1>
